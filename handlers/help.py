...
async def show_help(message: Message, state: FSMContext, bot: Bot):
    ...
    help_text = (
        ...
        f"/switch_my_set - выбрать другой набор слов для изучения\n\n" +
    ...
    if message.from_user.id in ADMIN_IDS:
        admin_commands = (
            ...
            f"/switch <code>{html.escape('[имя файла]')}</code> - изменить активный файл\n" +
            f"/current_file - показать активный файл\n" +
